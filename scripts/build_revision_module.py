...
REVISION_DATA = {
    ...
    2: {
        ...
        "rapid_fire": [
            ...
            ("What is the verified commercial track record achieved by BulkBeat TV?", "Scaled to 6,000+ users and generated ₹1.11 Lakhs in commercial revenue within months with sub-5s Telegram alerts.")
        ]
    },
    3: {
    ...
    4: {
        ...
        "rapid_fire": [
            ...
            ("In BEVM, how does sequential SHA-256 hash chaining prevent ballot tampering?", "Each cast vote incorporates the SHA-256 hash of the previous block; modifying any past record breaks all downstream hashes."),
            ("How does BEVM mathematically prevent double-voting?", "Via an atomic SQLite transaction that verifies has_voted == 0, records the encrypted ballot, and sets has_voted = 1 within a single commit.")
        ]
    },
    5: {
...
DAYS_METADATA = [
    ...
    (9, "Regula-Falsi & Newton-Raphson Methods", "BCA-5004", "Boats, Streams & Circular Tracks", "Fast & Slow Pointers (Linked List Mid/Cycle)", "DBMS Architecture & Three-Schema Model", "Biometric Electronic Voting System (BEVM)"),
    ...
    (16, "Knowledge Sharing, Transfer & Communities of Practice", "BCA-5001", "Linear & Circular Seating Arrangement", "Tree Traversals: DFS Pre, In, Post", "Error Detection & Correction: CRC & Hamming", "Biometric Electronic Voting System (BEVM)"),
    ...
    (23, "Transport Layer: TCP Handshake, Sliding Window & UDP", "BCA-5003", "Sentence Correction & Subject-Verb Agreement", "Dijkstra's Shortest Path Algorithm", "Python Memory Model: PyObject, GIL & RefCount", "Biometric Electronic Voting System (BEVM)"),
    ...
    (29, "Academic Sprint: 15-Mark University Answer Blueprints", "CSJMU All", "Infosys & Wipro Critical Reasoning Simulation", "Trie (Prefix Tree) Insertion & Search", "Comprehensive Core CS Placement Technical Review", "Biometric Electronic Voting System (BEVM)"),
