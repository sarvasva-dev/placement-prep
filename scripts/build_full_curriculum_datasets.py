...
SYLLABUS = [
    ...
    (4, "Computer Networks", "BCA-5003", "Unit I — OSI 7-Layer Reference Model vs TCP/IP Suite", "Ratio, Proportion & Variations", "Classical Synchronization (Dining Philosophers)", "TerraStract", "Fast & Slow Pointers (Floyd's Tortoise)"),
    ...
    (9, "Numerical Methods", "BCA-5004", "Unit I — Regula-Falsi & Newton-Raphson Method", "Boats, Streams & Circular Tracks", "DBMS Architecture & Three-Schema Model", "TerraStract", "Fast & Slow Pointers (Cycle & Midpoint)"),
    ...
    (16, "Knowledge Management", "BCA-5001", "Unit III — Knowledge Sharing & Communities of Practice", "Linear & Circular Seating Arrangement", "Error Detection & Correction: CRC & Hamming Code", "TerraStract", "Tree Traversals: DFS Pre, In, Post"),
    ...
    (23, "Computer Networks", "BCA-5003", "Unit IV — Transport Layer: TCP Handshake & Congestion Control", "Sentence Correction & Subject-Verb Agreement", "Python Memory Model: PyObject, GIL & Reference Counts", "TerraStract", "Dijkstra's Shortest Path Algorithm"),
    ...
    (29, "Academic Sprint", "CSJMU All", "Day 29 — High-Frequency 15-Mark University Blueprints", "Infosys & Wipro Critical Reasoning Simulation", "Comprehensive Core CS Placement Technical Review", "TerraStract", "Trie (Prefix Tree) Insertion & Search"),
...
def write_curriculum_files(aptitude_mcqs, mixed_tests):
    ...
    mixed_code = (
        ...
        '- 5 Coding & Project MCQs (DSA Patterns, CSMS, SmartGalla, BulkBeat TV, Caloriv, TerraStract, BEVM)\n\n'
