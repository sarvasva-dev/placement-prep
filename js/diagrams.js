...
export function renderSvgDiagram(diagramType, rawText = '') {
  ...
  if (typeKey.includes('csms') || typeKey.includes('smartgalla') || typeKey.includes('bulkbeat') || typeKey.includes('nse2') || typeKey.includes('terrastract') || typeKey.includes('caloriv')) {
